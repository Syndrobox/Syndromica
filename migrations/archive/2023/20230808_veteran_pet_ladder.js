  ...
  if (user.items.pets['Fox-Veteran']) {
    ...
    push.notifications.$each.push({
      ...
      data: {
        ...
        text: 'To commemorate being here for a new era of syndromica, we’ve awarded you a Veteran Dragon.',
    ...
    push.notifications.$each.push({
      ...
      data: {
        ...
        title: 'You’ve received a Veteran Pet!',
        text: 'To commemorate being here for a new era of syndromica, we’ve awarded you a Veteran Fox.',
        destination: '/inventory/stable',
      },
      seen: false,
    });
    ...
    push.notifications.$each.push({
      ...
      data: {
        ...
        title: 'You’ve received a Veteran Pet!',
        text: 'To commemorate being here for a new era of syndromica, we’ve awarded you a Veteran Bear.',
        destination: '/inventory/stable',
      },
      seen: false,
    });
    ...
    push.notifications.$each.push({
      ...
      data: {
        ...
        title: 'You’ve received a Veteran Pet!',
        text: 'To commemorate being here for a new era of syndromica, we’ve awarded you a Veteran Lion.',
        destination: '/inventory/stable',
      },
      seen: false,
    });
    ...
    push.notifications.$each.push({
      ...
      data: {
        ...
        title: 'You’ve received a Veteran Pet!',
        text: 'To commemorate being here for a new era of syndromica, we’ve awarded you a Veteran Tiger.',
        destination: '/inventory/stable',
      },
      seen: false,
    });
    ...
    push.notifications.$each.push({
      ...
      data: {
        ...
        title: 'You’ve received a Veteran Pet!',
        text: 'To commemorate being here for a new era of syndromica, we’ve awarded you a Veteran Wolf.',
        destination: '/inventory/stable',
      },
      seen: false,
    });
