...
const holidayAchievs = {
  SyndromicaDays: {
    icon: 'achievement-SyndromicaDay',
    singularTitleKey: 'SyndromicaDay',
    singularTextKey: 'SyndromicaDaySingularText',
    pluralTitleKey: 'SyndromicaDay',
    pluralTextKey: 'SyndromicaDayPluralText',
  },
  habitBirthdays: {
