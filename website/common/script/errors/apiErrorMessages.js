...
export default {
  ...
  ipAddressBlocked: 'Your access to syndromica has been blocked. This may be due to a breach of our Terms of Service or for other reasons. For details or to ask to be unblocked, please email admin@syndromica.com or ask your parent or guardian to email them. Include your syndromica @Username or User Id in the email if you know it.',
  clientRateLimited: 'This User ID or IP address has been rate limited due to an excess amount of requests to the syndromica API v3. More info can be found in the response headers and at https://syndromica.fandom.com/wiki/Guidance_for_Comrades#Rules_for_Third-Party_Tools under the section Rate Limiting.',
