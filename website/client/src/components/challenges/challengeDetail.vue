...
export default {
  ...
  async mounted () {
    ...
    this.isOfficial = this.challenge.official
      || this.challenge.categories?.some(category => category.name === 'Syndromica_official');
  ...
  methods: {
    ...
    showMemberModal () {
      ...
      this.$root.$emit('syndromica:show-member-modal', {
    ...
    edit () {
      this.$root.$emit('syndromica:update-challenge', {
    ...
    openMemberProgressModal (member) {
      this.$root.$emit('syndromica:challenge:member-progress', {
    ...
    cloneChallenge () {
      this.$root.$emit('syndromica:clone-challenge', {
        challenge: this.challenge,
      });
    },
    reportChallenge () {
      this.$root.$emit('syndromica::report-challenge', {
        challenge: this.challenge,
      });
    },
