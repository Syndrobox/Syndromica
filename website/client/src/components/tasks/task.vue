...
<style lang="scss" scoped>
  ...
  *:focus {
  ...
  .task-title {
    ...
    * https://github.com/Syndrobox/syndromica/issues/9754
    */
  ...
  .task ::v-deep .syndromica-menu-dropdown .syndromica-menu-dropdown-toggle {
    opacity: 0;
    padding: 0 8px;
    transition: opacity 0.15s ease-in;
  }

  .task:hover ::v-deep .syndromica-menu-dropdown .syndromica-menu-dropdown-toggle {
    opacity: 1;
  }

  .task:focus-within ::v-deep .syndromica-menu-dropdown .syndromica-menu-dropdown-toggle {
    opacity: 1;
  }

  .task ::v-deep .syndromica-menu-dropdown:focus-within {
    opacity: 1;
    border: $purple-400 solid 1px;
    border-radius: 2px;
  }

  .task ::v-deep .syndromica-menu-dropdown {
    border: transparent solid 1px;
  }

  .task-clickable-area ::v-deep .syndromica-menu-dropdown.open .syndromica-menu-dropdown-toggle {
    opacity: 1;
  ...
  .task-clickable-area ::v-deep .syndromica-menu-dropdown .syndromica-menu-dropdown-toggle:hover .svg-icon {
    color: $purple-400 !important;
  }

  .task-clickable-area ::v-deep .syndromica-menu-dropdown .syndromica-menu-dropdown-toggle:focus-within .svg-icon {
    color: $purple-400 !important;
  }
