  ...
  <div class="form-wrapper">
    ...
    >
      <div class="text-center">
        <div>
          <div
            class="svg-icon svg syndromica-logo"
            v-html="icons.SyndromicaIcon"
          ></div>
        </div>
      </div>
    ...
    >
      <div class="text-center">
        ...
        <div>
          <div
            class="svg-icon syndromica-logo"
            v-html="icons.SyndromicaIcon"
          ></div>
        </div>
        <div class="header">
    ...
    >
      <div class="text-center">
        <div>
          <div
            class="svg-icon syndromica-logo color"
            v-html="icons.SyndromicaIcon"
          ></div>
        </div>
        <div class="header">
...
import SyndromicaIcon from '@/assets/svg/logo-horizontal.svg';
