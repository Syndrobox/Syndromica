    ...
    <footer>
      ...
      <div class="product">
        ...
        <ul>
          <li>
            <a
              href="https://itunes.apple.com/us/app/syndromica/id994882113?ls=1&mt=8"
              target="_blank"
            >{{ $t('mobileIOS') }}
            </a>
          </li>
          <li>
            <a
              href="https://play.google.com/store/apps/details?id=com.syndrobox.android.syndromica"
              target="_blank"
            >{{ $t('mobileAndroid') }}
            </a>
          </li>
      ...
      <div class="company">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://syndromica.wordpress.com/"
              target="_blank"
            >{{ $t('companyBlog') }}
            </a>
          </li>
          <li>
            <a
              href="https://syndromica.fandom.com/wiki/Whats_New"
              target="_blank"
            >{{ $t('oldNews') }}
            </a>
          </li>
      ...
      <div class="community">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://syndromica.fandom.com/wiki/Contributing_to_Syndromica"
              target="_blank"
            >{{ $t('companyContribute') }}
            </a>
          </li>
          <li>
            <a
              href="https://translate.syndromica.com/"
              target="_blank"
            >{{ $t('translateSyndromica') }}
            </a>
          </li>
        </ul>
      </div>
      ...
      <div class="support">
        ...
        <ul>
          ...
          >
            <a
              href="mailto:admin@syndromica.com?subject=syndromica Web Bug Report"
              target="_blank"
            >
              {{ $t('reportBug') }}
            </a>
          ...
          <li>
            <a
              href="https://syndromica.fandom.com/"
              target="_blank"
            >{{ $t('wiki') }}
            </a>
          </li>
      ...
      <div class="developers">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://syndromica.fandom.com/wiki/Guidance_for_Blacksmiths"
              target="_blank"
          ...
          <li>
            <a
              href="https://syndromica.fandom.com/wiki/Extensions,_Add-Ons,_and_Customizations"
              target="_blank"
      ...
      <!-- Help Support syndromica -->
      <div class="donate">
        <div>
          <h3>{{ $t('helpSupportSyndromica') }}</h3>
          <p class="donate-text">
            {{ $t('donateText3') }}
          </p>
        </div>
      ...
      <div class="social">
        <div>
          ...
          <div class="icons">
            <a
              class="social-circle"
              href="https://www.instagram.com/syndromica/"
              target="_blank"
            >
              <div
            ...
            <a
              class="social-circle"
              href="https://twitter.com/syndromica/"
              target="_blank"
            >
              <div
            ...
            <a
              class="social-circle"
              href="https://www.facebook.com/syndromica/"
              target="_blank"
            >
              <div
      ...
      <div class=" copyright">
        <div>
          © {{ currentYear }} syndromica. All rights reserved.
        </div>
      </div>
      <div class="melior">
        <div
...
export default {
  ...
  computed: {
    ...
    getDataDisplayToolUrl () {
      const base = 'https://tools.syndromica.com/';
