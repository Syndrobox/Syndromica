<template>
  ...
  <div class="container-fluid">
    ...
    <p>
      Syndrobox, Inc. (“Syndrobox,” “we,” “us,” or “our”) welcomes you. This privacy notice (the “Privacy
      Notice”) describes how we process the information we collect about or from you through our Website
      located at <a href="https://syndromica.com/static/home">https://syndromica.com/static/home</a> and/or our Apps
      (our “Digital Platforms”), from our users, subscribers, visitors and other users of our technology and
      platforms (together with our Digital Platforms, the “syndromica Service” or the “Service”), and when you
    ...
    <p>
      In the course of operating the Service, Syndrobox collects or receives the following types of information
    ...
    <h3>User Content</h3>
    <p>
      As explained in more detail in the Terms of Service, Syndrobox allows you to upload and receive content,
    ...
    <p>
      ...
      personal information as set forth in this Privacy Notice. This Notice shall be binding upon Syndrobox and
    ...
    <p>
      ...
      admin@syndromica and we will handle your request within 30 days.
    </p>
    <p>
      You may opt out at any time from the use of your personal information for direct marketing purposes by
      emailing the instructions to <a href="mailto:admin@syndromica.com">admin@syndromica.com</a> or by clicking
      on the “Unsubscribe” link located on the bottom of any Syndrobox marketing email and following the
    ...
    <p>
      Syndrobox takes very seriously the security and privacy of the personal information that it collects
    ...
    <p>
      ...
      information to us, please contact us at admin@syndromica.com, and we will endeavor to delete that
    ...
    <p>
      ...
      to submit a request pursuant to Section 1798.83, please contact Syndrobox via email at
      <a href="mailto:admin@syndromica.com">admin@syndromica.com</a>.
    </p>
    ...
    <p>
      ...
      third parties. You can exercise this right by contacting us at admin@syndromica.com with the subject line
      “Nevada Do Not Sell Request” and providing us with your name and the email address associated with
      your account.
    </p>
    <h2>DO NOT TRACK</h2>
    <p>
      Syndrobox does not respond to “Do Not Track” settings or other related mechanisms on our Website at
      this time.
    </p>
    ...
    <p>
      The Service may contain links to third-party websites (“<span style="text-decoration: underline;">External
        Sites</span>”). Syndrobox has no control over the privacy practices or the content of any such External Sites.
    ...
    <p>
      If you have questions about this Privacy Notice, please e-mail us at <a href="mailto:admin@syndromica.com">
        admin@syndromica.com</a> with “Privacy Notice” in the subject line.
    </p>
    <address>
      <strong>Syndrobox, Inc.</strong>
