...
export const TaskSchema = new Schema({
  ...
  bySyndromica: { $type: Boolean, default: false }, // Flag of Tasks that were created by syndromica
}, _.defaults({
  minimize: false, // So empty objects are returned
  strict: true,
  typeKey: '$type', // So that we can use fields named `type`
...
TaskSchema.plugin(baseModel, {
  ...
  sanitizeTransform (taskObj) {
    ...
    // See https://github.com/Syndrobox/syndromica-ios/commit/4cd05f80363502eb7652e057aa564c85546f7806
...
// See https://syndromica.fandom.com/wiki/Challenges#Challenge_Participant.27s_Permissions for more info
