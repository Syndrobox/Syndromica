...
function _populateDefaultTasks (user, taskTypes) {
  let defaultsData;
  if (user.registeredThrough === 'syndromica-android' || user.registeredThrough === 'syndromica-ios') {
  ...
  const tasksToCreate = [];
  if (user.registeredThrough === 'syndromica-web') return Promise.all(tasksToCreate);
...
function _setUpNewUser (user) {
  ...
  if (user.registeredThrough === 'syndromica-web') {
...
schema.post('init', function postInitUser () {
  ...
  // In particular:
  // - tags https://github.com/Syndrobox/syndromica/issues/10688
  // - notifications https://github.com/Syndrobox/syndromica/issues/9923
  // - push devices https://github.com/Syndrobox/syndromica/issues/11805
  //            and https://github.com/Syndrobox/syndromica/issues/11868
