...
const RESTRICTED_EMAIL_DOMAINS = Object.freeze(['syndromica.com', 'syndrobox.com']);
...
export const UserSchema = new Schema({
  ...
  contributor: {
    // 1-9, see https://syndromica.fandom.com/wiki/Contributor_Rewards
    level: {
      $type: Number,
      min: 0,
      max: 9,
  ...
  // Items the user manually unpinned from the ones suggested by syndromica
  unpinnedItems: [{
    _id: false,
    path: { $type: String },
    type: { $type: String },
