 ...
 *                                   'syndrobox' for tavern are accepted).
 *
 * @apiSuccess {Array} data An array of <a href='https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js#L51' target='_blank'>chat messages</a>
 *
...
api.postChat = {
  ...
  async handler (req, res) {
    ...
    if (client) {
      client = client.replace('syndromica-', '');
    }
 ...
 *
 * @apiSuccess {Object} data The liked <a href='https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js#L51' target='_blank'>chat message</a>
 *
 * @apiUse GroupNotFound
 ...
 * @apiGroup Chat
 *
 * @apiParam (Path) {UUID} groupId The group id ('party' for the user party and 'syndrobox'
 *                                 for tavern are accepted)
