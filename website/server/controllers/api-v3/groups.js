 ...
 *
 * @apiSuccess (201) {Object} data The created group (See <a href="https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js" target="_blank">/website/server/models/group.js</a>)
 *
 ...
 *
 * @apiSuccess {Object[]} data An array of the requested groups (See <a href="https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js" target="_blank">/website/server/models/group.js</a>)
 *
 ...
 *                                   and 'syndrobox' for tavern are accepted)
 *
 * @apiParamExample {String} Tavern:
 *     /api/v3/groups/syndrobox
 *
 * @apiSuccess {Object} data The group object (See <a href="https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js" target="_blank">/website/server/models/group.js</a>)
 *
 ...
 * @apiGroup Group
 *
 * @apiParam (Path) {String} groupId The group _id ('party' for the user party and 'syndrobox'
 ...
 *
 * @apiSuccess {Object} data The updated group (See <a href="https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js" target="_blank">/website/server/models/group.js</a>)
 *
 * @apiSuccessExample {json} Tavern:
 *     HTTP/1.1 200 OK
 *     {
 ...
 * @apiGroup Group
 *
 * @apiParam (Path) {UUID} groupId The group _id ('party' for the user party and 'syndrobox'
 *                                 for tavern are accepted).
 *
 * @apiParamExample {String} Tavern:
 *     /api/v3/groups/syndrobox/join
 *
 * @apiSuccess {Object} data The joined group (See <a href="https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js" target="_blank">/website/server/models/group.js</a>)
 *
 * @apiSuccessExample {json} Tavern:
 *     HTTP/1.1 200 OK
 *     {
...
api.joinGroup = {
  ...
  async handler (req, res) {
    ...
    req.checkParams('groupId', apiError('groupIdRequired')).notEmpty(); // .isUUID(); can't be used because it would block 'syndrobox' or 'party'
 ...
 * @apiGroup Group
 *
 * @apiSuccess {Object[]} data An array of the requested groups with a group plan (See <a href="https://github.com/Syndrobox/syndromica/blob/develop/website/server/models/group.js" target="_blank">/website/server/models/group.js</a>)
 *
