 ...
 *
 * @apiSuccess {Object} data Various data about the content of syndromica. The content route
...
api.getContent = {
  ...
  async handler (req, res) {
    ...
    if (filter === '') {
      if (req.headers['x-client'] === 'syndromica-android') {
        filter = ANDROID_FILTER;
      } else if (req.headers['x-client'] === 'syndromica-ios') {
        filter = IOS_FILTER;
      }
    }
