 ...
 *     {
 *       "text":"Update syndromica API Documentation - Tasks",
 *       "type":"todo",
 *       "alias":"hab-api-tasks",
 ...
 * curl -i https://syndromica.com/api/v3/tasks/challenge/f23c12f2-5830-4f15-9c36-e17fd729a812
 *
 * @apiSuccess {Array} data An array of tasks
 *
 * @apiSuccessExample {json} Example return:
 ...
 *
 * @apiExample {curl} Example use:
 * curl -i https://syndromica.com/api/v3/tasks/54a81d23-529c-4daa-a6f7-c5c6e7e84936
 *
 ...
 * curl -X "POST" https://syndromica.com/api/v3/tasks/test-api-params/score/up
 *
...
api.moveTask = {
  ...
  async handler (req, res) {
    ...
    // See https://github.com/Syndrobox/syndromica/pull/9321#issuecomment-354187666 for more info
 ...
 *
 * @apiExample {curl} Example use:
 * curl -X "DELETE" https://syndromica.com/api/v3/tasks/test-api-params/tags/3d5d324d-a042-4d5f-872e-0553e228553e
 *
 * @apiSuccess {Object} data The updated task
 *
 * @apiSuccessExample {json} Example return:
 ...
 * curl -X "POST" https://syndromica.com/api/v3/tasks/unlink-all/f23c12f2-5830-4f15-9c36-e17fd729a812?keep=remove-all
 *
 ...
 *
 * @apiExample {curl} Example call:
 * curl -X "POST" https://syndromica.com/api/v3/tasks/unlink-one/ee882e1d-ebd1-4716-88f2-4f9e47d947a8?keep=keep
 *
 * @apiSuccess {Object} data An empty object
 *
 * @apiUse TaskNotFound
 ...
 *
 * @apiExample {curl} Example call:
 * curl -X "POST" https://syndromica.com/api/v3/tasks/ClearCompletedTodos
 *
 * @apiSuccess {Object} data An empty object
 *
 * @apiSuccessExample {json} Example return:
 ...
 *
 * @apiExample {json} Example call:
 * curl -X "DELETE" https://syndromica.com/api/v3/tasks/3d5d324d-a042-4d5f-872e-0553e228553e
 *
 * @apiSuccess {Object} data An empty object
 *
 * @apiUse TaskNotFound
