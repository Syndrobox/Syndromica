 ...
 * @apiDescription Returns an array of objects containing the patrons who backed syndromica's
 ...
 * contributed for syndromica. The array is sorted by the contribution level in descending order.
 *
...
api.updateHero = {
  ...
  async handler (req, res) {
    ...
    if (updateData.balance && updateData.balance !== hero.balance) {
      await hero.updateBalance(updateData.balance - hero.balance, 'admin_update_balance', '', 'Given by syndromica staff');
