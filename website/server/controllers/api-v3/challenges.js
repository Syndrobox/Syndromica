 ...
 *                                          this is an official syndromica challenge.
 *
 */
 ...
 *                                             syndromica challenge (requires admin).
...
api.getGroupChallenges = {
  ...
  async handler (req, res) {
    ...
    if (groupId === 'syndrobox') groupId = TAVERN_ID;
...
api.exportChallengeCsv = {
  ...
  async handler (req, res) {
    ...
    tasks.forEach(task => {
       ...
       * See more at https://github.com/Syndrobox/syndromica/issues/8350
       */
