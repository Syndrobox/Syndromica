...
const OFFICIAL_PLATFORMS = ['syndromica-web', 'syndromica-ios', 'syndromica-android'];
 ...
 * curl -i https://syndromica.com/api/v3/user?userFields=achievements,items.mounts
 *
 ...
 *   --  https://github.com/Syndrobox/syndromica/tree/develop/website/server/models/user
 *   }
 * }
 *
*/
 ...
 * https://syndromica.com/api/v3/user/hatch/Dragon/CottonCandyPink
 *
 ...
 *
 * @apiParamExample {URL} Example-URL
 * https://syndromica.com/api/v3/user/equip/equipped/weapon_warrior_2
 *
 * @apiSuccess {Object} data user.items
 ...
 *
 * @apiParamExample {url} Example-URL
 * https://syndromica.com/api/v3/user/feed/Armadillo-Shade/Chocolate
 * https://syndromica.com/api/v3/user/feed/Armadillo-Shade/Chocolate?amount=9
 *
 ...
 * curl -X POST https://syndromica.com/api/v3/user/unlock?path=background.midnight_clouds
 * curl -X POST https://syndromica.com/api/v3/user/unlock?path=hair.color.midnight
 *
