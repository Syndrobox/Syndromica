...
export function canBuySkuItem (sku, user) {
  switch (sku) {
    case 'com.syndrobox.android.syndromica.iap.pets.gryphatrice_jubilant':
    case 'com.syndrobox.ios.syndromica.pets.Gryphatrice_Jubilant':
...
export async function buySkuItem (data) {
  ...
  switch (data.sku) { // eslint-disable-line default-case
    case 'com.syndrobox.android.syndromica.iap.4gems':
    case 'com.syndrobox.ios.syndromica.4gems':
      gemsBlockKey = '4gems';
      break;
    case 'com.syndrobox.android.syndromica.iap.20gems':
    case 'com.syndrobox.android.syndromica.iap.21gems':
    case 'com.syndrobox.ios.syndromica.20gems':
    case 'com.syndrobox.ios.syndromica.21gems':
      gemsBlockKey = '21gems';
      break;
    case 'com.syndrobox.android.syndromica.iap.42gems':
    case 'com.syndrobox.ios.syndromica.42gems':
      gemsBlockKey = '42gems';
      break;
    case 'com.syndrobox.android.syndromica.iap.84gems':
    case 'com.syndrobox.ios.syndromica.84gems':
      gemsBlockKey = '84gems';
      break;
    case 'com.syndrobox.android.syndromica.iap.pets.gryphatrice_jubilant':
    case 'com.syndrobox.ios.syndromica.pets.Gryphatrice_Jubilant':
