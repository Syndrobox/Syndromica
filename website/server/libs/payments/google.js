...
api.subscribe = async function subscribe (
  ...
  switch (sku) { // eslint-disable-line default-case
    case 'com.syndrobox.android.syndromica.subscription.1month':
      subCode = 'basic_earned';
      break;
    case 'com.syndrobox.android.syndromica.subscription.3month':
      subCode = 'basic_3mo';
      break;
    case 'com.syndrobox.android.syndromica.subscription.6month':
      subCode = 'basic_6mo';
      break;
    case 'com.syndrobox.android.syndromica.subscription.12month':
      subCode = 'basic_12mo';
      break;
  }
...
api.noRenewSubscribe = async function noRenewSubscribe (options) {
  ...
  let subCode;
  switch (sku) { // eslint-disable-line default-case
    case 'com.syndrobox.android.syndromica.norenew_subscription.1month':
      subCode = 'basic_earned';
      break;
    case 'com.syndrobox.android.syndromica.norenew_subscription.3month':
      subCode = 'basic_3mo';
      break;
    case 'com.syndrobox.android.syndromica.norenew_subscription.6month':
      subCode = 'basic_6mo';
      break;
    case 'com.syndrobox.android.syndromica.norenew_subscription.12month':
      subCode = 'basic_12mo';
      break;
  }
  const sub = subCode ? shared.content.subscriptionBlocks[subCode] : false;
