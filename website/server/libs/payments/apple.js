...
api.subscribe = async function subscribe (user, receipt, headers, nextPaymentProcessing) {
  ...
  switch (purchase.productId) { // eslint-disable-line default-case
    case 'subscription1month':
      ...
      break;
    case 'com.syndrobox.ios.syndromica.subscription.3month':
      subCode = 'basic_3mo';
      break;
    case 'com.syndrobox.ios.syndromica.subscription.6month':
      subCode = 'basic_6mo';
      break;
    case 'com.syndrobox.ios.syndromica.subscription.12month':
      subCode = 'basic_12mo';
      break;
  }
...
api.noRenewSubscribe = async function noRenewSubscribe (options) {
  ...
  switch (sku) { // eslint-disable-line default-case
    case 'com.syndrobox.ios.syndromica.norenew_subscription.1month':
      subCode = 'basic_earned';
      break;
    case 'com.syndrobox.ios.syndromica.norenew_subscription.3month':
      subCode = 'basic_3mo';
      break;
    case 'com.syndrobox.ios.syndromica.norenew_subscription.6month':
      subCode = 'basic_6mo';
      break;
    case 'com.syndrobox.ios.syndromica.norenew_subscription.12month':
      subCode = 'basic_12mo';
      break;
  }
  const sub = subCode ? shared.content.subscriptionBlocks[subCode] : false;
