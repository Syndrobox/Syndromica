...
/**
 * Uses SyndromicaMarkdown to determine which text blocks should be ignored (links and code blocks)
...
function findTextBlocks (text) {
  ...
  const tokens = SyndromicaMarkdown.parse(text, {});
...
function determineBaseUrl () {
  ...
  return process.env.NODE_ENV === 'production' ? 'https://syndromica.com' : '';
}
