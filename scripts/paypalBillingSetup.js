...
const billingPlanTitle = 'syndromica Subscription';
const billingPlanAttributes = {
  description: billingPlanTitle,
  type: 'INFINITE',
  merchant_preferences: {
    auto_bill_amount: 'yes',
    cancel_url: live ? 'https://syndromica.com' : 'http://localhost:3000',
    return_url: `${live ? 'https://syndromica.com' : 'http://localhost:3000'}/paypal/subscribe/success`,
  },
  payment_definitions: [{
    type: 'REGULAR',
    frequency: 'MONTH',
...
switch (OP) {
  ...
  case 'update':
    const updatePayload = {
      ...
      value: {
        cancel_url: 'https://syndromica.com',
      },
    };
