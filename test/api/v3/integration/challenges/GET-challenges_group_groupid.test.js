...
describe('GET challenges/groups/:groupId', () => {
  ...
  context('Tavern', () => {
    ...
    it('should return tavern challenges using ID "syndrobox"', async () => {
      const challenges = await user.get('/challenges/groups/syndrobox');
    ...
    context('official challenge is present', () => {
      ...
      before(async () => {
        ...
        officialChallenge = await generateChallenge(user, tavern, {
          categories: [{
            name: 'Syndromica_official',
            slug: 'Syndromica_official',
          }],
          prize: 1,
        });
      ...
      it('should return newest challenges first, after official ones', async () => {
        let challenges = await user.get('/challenges/groups/syndrobox');
        ...
        challenges = await user.get('/challenges/groups/syndrobox');
