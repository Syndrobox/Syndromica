...
describe('POST /challenges', () => {
  ...
  context('creating a Challenge for a Group Plan', () => {
    ...
    it('does not set Syndromica_official category for non-admins', async () => {
      const testCategory = { _id: '65c1172997c0b24600371ea9', slug: 'Syndromica_official', name: 'Syndromica_official' };
      await expect(groupLeader.post('/challenges', {
        group: group._id,
        name: 'Test Challenge',
        shortName: 'TC Label',
    ...
    it('sets Syndromica_official category for admins', async () => {
      await groupLeader.updateOne({
        permissions: {
          challengeAdmin: true,
        },
    ...
    it('sets official if the Syndromica_official category is set for admins', async () => {
      await groupLeader.updateOne({
        permissions: {
          challengeAdmin: true,
        },
