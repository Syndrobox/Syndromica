...
describe('GET /email/unsubscribe', () => {
  let user;
  const testEmail = 'test@syndromica.com';
  ...
  it('unsubscribes an email from notifications', async () => {
    ...
    expect(unsubscribedMessage).to.equal('<h1>Unsubscribed successfully!</h1> You won\'t receive any other email from syndromica.');
  });
