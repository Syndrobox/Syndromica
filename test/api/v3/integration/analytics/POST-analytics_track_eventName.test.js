...
describe('POST /analytics/track/:eventName', () => {
  it('calls res.analytics', async () => {
    ...
    const requestWithHeaders = requester(user, { 'x-client': 'syndromica-web' });
    await requestWithHeaders.post('/analytics/track/eventName', { data: 'example' }, { 'x-client': 'syndromica-web' });
