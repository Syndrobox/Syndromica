  ...
  it('Flags a chat and sends normal message to moderator Slack when user is not new', async () => {
    ...
    expect(IncomingWebhook.prototype.send).to.be.calledWith({
      ...
      attachments: [{
        ...
        text: TEST_MESSAGE,
        footer: `<https://syndrobox.github.io/flag-o-rama/?groupId=${group._id}&chatId=${message.id}|Flag this message.>`,
        mrkdwn_in: [
          'text',
        ],
      }],
  ...
  it('Does not increment message flag count and sends different message to moderator Slack when user is new', async () => {
    ...
    expect(IncomingWebhook.prototype.send).to.be.calledWith({
      ...
      attachments: [{
        ...
        title_link: undefined,
        text: TEST_MESSAGE,
        footer: `<https://syndrobox.github.io/flag-o-rama/?groupId=${group._id}&chatId=${message.id}|Flag this message.> ${automatedComment}`,
        mrkdwn_in: [
          'text',
        ],
      }],
