...
describe('Apple Payments', () => {
  ...
  describe('verifyPurchase', () => {
    ...
    beforeEach(() => {
      token = 'testToken';
      sku = 'com.syndrobox.ios.syndromica.iap.21gems';
      user = new User();
      ...
      iapGetPurchaseDataStub = sinon.stub(iap, 'getPurchaseData')
        .returns([{
          productId: 'com.syndrobox.ios.syndromica.21gems',
          transactionId: token,
        }]);
    ...
    const gemsCanPurchase = [
      {
        productId: 'com.syndrobox.ios.syndromica.4gems',
        gemsBlock: '4gems',
      },
      {
        productId: 'com.syndrobox.ios.syndromica.20gems',
        gemsBlock: '21gems',
      },
      {
        productId: 'com.syndrobox.ios.syndromica.21gems',
      ...
      {
        productId: 'com.syndrobox.ios.syndromica.42gems',
        gemsBlock: '42gems',
      },
      {
        productId: 'com.syndrobox.ios.syndromica.84gems',
        gemsBlock: '84gems',
      },
    ];
    ...
    it('gifts gems', async () => {
      ...
      expect(paymentBuySkuStub).to.be.calledWith({
        ...
        paymentMethod: applePayments.constants.PAYMENT_METHOD_APPLE,
        sku: 'com.syndrobox.ios.syndromica.4gems',
        headers,
      });
    });
  });
  ...
  describe('subscribe', () => {
    ...
    beforeEach(() => {
      ...
      sku = 'com.syndrobox.ios.syndromica.subscription.3month';
    ...
    const subOptions = [
      ...
      {
        sku: 'com.syndrobox.ios.syndromica.subscription.6month',
        subKey: 'basic_6mo',
      },
      {
        sku: 'com.syndrobox.ios.syndromica.subscription.12month',
        subKey: 'basic_12mo',
      },
    ];
