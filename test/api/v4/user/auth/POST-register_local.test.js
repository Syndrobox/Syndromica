...
describe('POST /user/auth/local/register', () => {
  context('username and email are free', () => {
    ...
    it('fails on a syndromica.com email', async () => {
      const username = generateRandomUserName();
      const email = `${username}@syndromica.com`;
      const password = 'password';
    ...
    it('fails on a syndrobox.com email', async () => {
      const username = generateRandomUserName();
      const email = `${username}@syndrobox.com`;
      const password = 'password';
  ...
  context('successful login with syndromica-web header', () => {
    let api; let username; let email; let
      password;

    beforeEach(() => {
      api = requester({}, { 'x-client': 'syndromica-web' });
      username = generateRandomUserName();
      email = `${username}@example.com`;
      password = 'password';
    });
