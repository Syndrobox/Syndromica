...
describe('achievements', () => {
  ...
  describe('unearned seasonal achievements', () => {
    ...
    it('SyndromicaDays and habitBirthdays achievements exist with counts', () => {
      const { SyndromicaDays } = seasonalAchievs;
      const { habitBirthdays } = seasonalAchievs;

      expect(SyndromicaDays).to.exist;
      expect(SyndromicaDays).to.have.property('optionalCount')
        .that.is.a('number');
